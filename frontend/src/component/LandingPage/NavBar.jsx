        ...
        <>
            <div className=" flex justify-between px-2 bg-white shadow items-center">
                <div className=" flex items-center justify-center gap-1.5 ml-12 cursor-pointer">
                    ...
                    <h1 className="text-black text-[28px] font-bold"> Agri<span
                        className=" text-indigo-600">Bloom</span></h1>
                </div>
                <div>
                    <Router>
                ...
                <div className="flex-center space-x-3 mr-6">
                    <Button className="bg-black hover:opacity-70 text-white rounded-md">Sign Up</Button>
                    <Button className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-md">Sign In</Button>
                </div>
            </div>
        </>
    )
