<<<<<<<< HEAD:backend/login/src/main/java/com/example/backend/GeneralTech/model/task.java
package com.example.demo.GeneralTech.model;
========
package com.example.backend.ChiefTech.model;
>>>>>>>> origin/master:backend/login/src/main/java/com/example/backend/ChiefTech/model/task.java
